...
const ProjectCard = ({ project, aosDelay }) => (
  ...
  >
    <div className={`rounded-2xl p-6 md:p-8 h-full backdrop-blur-md transition-all duration-500 ${
      ...
      {/* Optional Project Screenshot Container (ready for later addition) */}
      {project.image && (
        <div className="w-full aspect-video rounded-xl overflow-hidden mb-6 bg-black/40 border border-white/10 relative group/img">
          <img 
            src={project.image} 
            alt={project.title} 
      ...
      {/* Description */}
      <p className="text-white/70 text-sm md:text-base leading-relaxed mb-6 max-w-3xl font-medium">
        {project.description}
      </p>
      ...
      {/* Action Buttons: strictly active or inactive without fabricated URLs */}
      <div className="flex flex-wrap gap-3">
        ...
        {project.links.github ? (
          ...
          <span className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/40 text-xs font-medium cursor-not-allowed">
            <GitHubIcon />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg font-medium leading-relaxed">
            A selection of platforms showcasing hands-on experience in full-stack architecture, RESTful APIs, and applied AI systems.
          </p>
        </div>
