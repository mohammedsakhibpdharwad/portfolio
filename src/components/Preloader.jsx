      ...
      {isLoading && (
        ...
        >
          ...
          <motion.div 
            ...
            className="relative text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter text-center"
          >
            ...
            <motion.div 
              className="absolute top-0 left-0 text-white overflow-hidden whitespace-nowrap w-full"
