...
const InternshipCard = ({ intern, index }) => (
  <div 
    ...
    className="bg-black/25 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-10 hover:scale-[1.01] hover:bg-black/40 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-500 flex flex-col justify-between max-w-3xl mx-auto w-full"
  >
    <div>
      <div className="flex justify-between items-start mb-6">
        <span className="text-white/70 text-xs font-mono font-bold tracking-widest uppercase bg-black/30 px-3 py-1 rounded-full border border-white/10">
          {intern.duration}
        </span>
      ...
      {/* Responsibilities */}
      <div className="mb-6">
        <h4 className="text-white/70 text-xs font-bold uppercase tracking-wider mb-3">Key Responsibilities:</h4>
        <ul className="text-white/95 text-sm md:text-base font-medium space-y-2 pl-4 list-disc">
    ...
    <div className="pt-6 border-t border-white/10">
      <h4 className="text-white/70 text-xs font-bold uppercase tracking-wider mb-3">Core Stack &amp; Tools:</h4>
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            Practical development experience applying full-stack architecture, API development, and systematic debugging.
          </p>
        </div>
