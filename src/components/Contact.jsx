...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isConfigured) {
      // EmailJS not configured with active keys — fallback directly to prefilled mailto client
  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0a0a0a] w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-gray-900">
      ...
      >
        <h1 
          className="text-[7vw] leading-[1] font-black text-white uppercase tracking-tighter select-none scale-y-[1.6] origin-top"
            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4">
              ...
              <div className="flex-1 flex items-start gap-4 text-sm font-medium text-white/90">
                ...
                <label htmlFor="permission" className="cursor-pointer max-w-[280px] leading-snug">
                  I give permission to contact me regarding development and engineering opportunities.
                </label>
              </div>
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/70 font-medium">
                <p className="leading-relaxed max-w-[400px]">
                  Your message will be sent directly to my inbox. I typically respond promptly.
                </p>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  <div className="max-w-[280px] leading-relaxed space-y-1">
                    <p>
                      Email: <a href={`mailto:${personalInfo.emails.primary}`} className="underline hover:text-white transition-colors">{personalInfo.emails.primary}</a>
                    </p>
                    <p>
                      Phone: <a href={`tel:${personalInfo.phone.replace(/\s+/g, '')}`} className="underline hover:text-white transition-colors">{personalInfo.phone}</a>
                    </p>
                  </div>
